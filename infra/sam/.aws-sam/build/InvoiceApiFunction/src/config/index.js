...
const config = {
  ...
  aws: {
    ...
    credentials: {
      ...
      // Needed for temporary credentials (e.g. Lambda, STS). If omitted while
      // overriding credentials, AWS calls will fail with "security token ... invalid".
      sessionToken: isLocalDb ? '' : process.env.AWS_SESSION_TOKEN || ''
    }
  },
  dynamodb: {
